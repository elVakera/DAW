# Supermercat 
Es un pequeño proyecto de clase que trata de desarrollar una aplicacion para gestionar un supermercado para paracticar el uso dde collections, gestionar excepciones y el uso de metodologia CRUD
# Main
~~~ java
package supermercat;
